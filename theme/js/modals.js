...
$(".add_customer").on("click", function (e) {
  ...
  if (email != '' && !validateEmail(email)) {
    ...
    //flag=false;
    toastr["warning"]("กรุณาป้อน Email ID.")
    return;
  }
  else {
    $("#email_msg").html("Email ไม่ถูกต้อง !").hide();
  }
  var this_id = this.id;
  ...
  $.ajax({
    ...
    success: function (result) {
      ...
      if (data.result == "success") {
        ...
        toastr["success"]("เพิ่มลูกค้าใหม่แล้ว!!");
  ...
  $.ajax({
    ...
    success: function (result) {
      ...
      if (result == "success") {
        ...
        toastr["success"]("เพิ่มตัวเลือก ใหม่แล้ว!!");
        success_sound.currentTime = 0;
        success_sound.play();
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        if (data.result == "success") {
          ...
          //$("#amount").val(data.advance);
          $('#brand_form')[0].reset();
          toastr["success"]("เพิ่มแบรนด์ ใหม่แล้ว!!");
          success_sound.currentTime = 0;
          success_sound.play();
        }
        else if (data.result == "failed") {
