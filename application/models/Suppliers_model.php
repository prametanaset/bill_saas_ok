  ...
  public function update_status($id,$status){
	...
	public function delete_suppliers_from_table($ids){
      ...
      if($q1->row()->tot_entrys >0 ){
        echo "มีใบแจ้งหนี้การซื้อของซัพพลายเออร์! กรุณาลบใบแจ้งหนี้การซื้อ!";exit();
      }
      ...
      <div class="modal-dialog ">
        <div class="modal-content">
          <div class="modal-header header-custom">
            ...
            <h4 class="modal-title text-center">จ่ายยอดซื้อที่ค้างชำระ</h4>
          </div>
        ...
        <div class="row">
          ...
          <div class="modal-footer">
            ...
            <button type="button" onclick="save_payment(<?=$supplier_id;?>)" class="btn bg-green btn-lg place_order btn-lg payment_save">บันทึก<i class="fa  fa-check "></i></button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
      ...
      <div class="modal-dialog ">
        <div class="modal-content">
          <div class="modal-header header-custom">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title text-center">รับเงินคืน จากส่งคืนสินค้า</h4>
          </div>
          <div class="modal-body">
          ...
          <div class="col-md-12">
            <div class="row invoice-info">
              ...
              <div class="col-sm-12 invoice-col">
                ...
                <table class="table table-sm table-bordered bg-info" width="100%">
                  <tr>
                    <td class="text-right"><?= $this->lang->line('total_purchase_return'); ?></td>
                    <td class="text-right"><?= $CI->currency($total_purchase_amount); ?></td>
                  </tr>
                  <tr>
                    <td class="text-right"><?= $this->lang->line('paid_amount'); ?></td>
                  ...
                  <tr>
                    <td class="text-right"><?= $this->lang->line('purchase_return_due'); ?></td>
