	...
	public function count_all()
  {
    ...
    $info = array(
                ...
                'max_invoices'        => $max_invoices,
                 ...
                 // Payment & Status Defaults for Manual Entry
                'payment_gross'    => ($monthly_price > 0) ? $monthly_price : 0,
                'payment_status'   => ($monthly_price == 0) ? 'Paid' : 'Unpaid',
                'package_status'   => ($monthly_price == 0) ? 1 : 0,
                'payment_type'     => 'Manual',
                /*System Info*/
      ...
      $info1 = array(
                ...
                'status'          => 1,
                'subscription_date' => $CUR_DATE, // Set subscription date
              );
