...
class Account_transactions_model extends MY_Model {
	...
	var $order = array('a.transaction_date' => 'asc'); // default primary order
	...
	private function _get_datatables_query()
	{
		...
		else if(isset($this->order))
		{
			...
			$this->db->order_by('a.id', 'asc'); // secondary order for same date
		}
	}
