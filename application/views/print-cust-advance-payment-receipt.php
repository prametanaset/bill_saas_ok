	...
	<table width="95%" align="center">
		<tr>
			<td align="center" width="30%">
				<img src="<?= base_url($store_logo);?>" width="20%" height="auto">
			</td>
		</tr>
		<tr>
			<td align="center">
...
?> <br/>
			...
			<td>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  >
					...
					<tr style="border-top-style: dashed;border-bottom-style: dashed;border-width: 0.1px;">
						...
						<th style="font-size: 11px; text-align: right;padding-left: 2px; padding-right: 2px;"><?= $this->lang->line('amount'); ?></th>
				   ...
				   <tfoot>
				   		<tr>
				   			<td style="padding-top: 80px;width:33%; text-align: center;" colspan="2"><?= $this->lang->line('customer_signature'); ?></td>
				   			<td  style="padding-top: 80px;width:33%;"></td>
				   			<td style="padding-top: 80px;width:33%;text-align: center;" colspan="2"><?= $this->lang->line('recipient_signature'); ?>							
						    </td>
				   		</tr>
				   </tfoot>
				</table>
  ...
  <div class="col-md-2 col-md-offset-5 col-xs-4 col-xs-offset-4 form-group">
    <button type="button" id="" class="btn btn-block btn-success btn-xs" onclick="window.print();" title="Print">พิมพ์</button>
