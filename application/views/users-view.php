        ...
        <div class="col-xs-12">
          ...
          $q1=$this->db->from('db_users as a, db_roles as b')->order_by('id','desc')->get();
            ...
            foreach ($q1->result() as $res1){
              ...
              $is_primary_admin = ($store_rec->user_id==$res1->id);
              $str= $is_primary_admin ? "<span class='label label-success' toggle='tooltip' style='cursor:pointer' title=''>Store Admin</span>" : '';
							?>
							<tr>
							<td> <?php echo $i++;?> </td>
              ...
              <td> <?php echo $res1->role_name;?> </td>
							...
							<td>
								<?php
                 if($res1->id==1 || ($is_primary_admin && !is_admin()))                   //1=Active, 0=Inactive
                ...
                <div class="btn-group" title="View Account">
                  <input type="hidden" id="base_url" value="<?php echo $base_url;; ?>">
                    ...
                    <ul role="menu" class="dropdown-menu dropdown-light pull-right">
                      ...
                      <?php } ?>
                      <?php if($CI->permissions('users_delete') && $res1->id!=1 && !($is_primary_admin && !is_admin())) { ?>
                      <li>
