      ...
      <div class="wrapper">
         ...
         <?php
            if(!isset($package_name)){
               ...
               $max_warehouses=
               $max_users=
               $max_items=$max_invoices=$max_etax_emails=
                        ...
                        <div class="box-body">
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-5">
                                 ...
                                 <div class="form-group">
                                    <label for="max_etax_emails" class="col-sm-4 control-label">Max ETAX Emails / Month<label class="text-danger">*</label></label>
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control only_currency" id="max_etax_emails" name="max_etax_emails" placeholder="" value="<?=$max_etax_emails?>" >
                                       <span class='text-warning pull-right'>Note: '-1' for Unlimited</span>
                                       <span id="max_etax_emails_msg" style="display:none" class="text-danger"></span>
                                    </div>
                                 </div>
