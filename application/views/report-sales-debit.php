...
<html>
   ...
   <body class="hold-transition skin-blue sidebar-mini">
                           ...
                           <table class="table table-bordered table-hover " id="report-data" >
                              <thead>
                                 <tr class="bg-success">
                                    ...
                                    <th class='text-center'><?= $this->lang->line('debit_date'); ?></th>
      ...
      <script src="<?php echo $theme_link; ?>js/report-sales-debit.js"></script>
      ...
      <script>$(".report-sales-debit-active-li").addClass("active");</script>
   </body>
</html>
