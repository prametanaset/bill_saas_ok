    ...
    <nav class="navbar navbar-static-top">
      <div class="container-fluid">
        <div class="navbar-header">
          <a href="<?php echo $base_url; ?>dashboard" class="navbar-brand" title="Go to Dashboard!"><b class="hidden-xs" style="color: white; font-size:larger; "><?= $this->session->userdata('store_name'); ?></b><b class="hidden-lg">miniERP</b></a>
       ...
       <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          ...
          <li class=" " id="">
            <a title="Dashboard" href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard text-aqua" ></i><b class="hidden-xs"><?= $this->lang->line(''); ?></b></a>
            </li>                     
       ...
       <div class="navbar-custom-menu">
         <ul class="nav navbar-nav">
            ...
            <li class=""><a href="<?php echo $base_url; ?>pos" title="Create New POS Invoice"><i class="fa fa-calculator text-aqua " ></i> <span style="color: gold; font-size:"><?= $this->lang->line('new_invoice'); ?></span></a></li>
            <?php } ?> 
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo $base_url; ?>logout" class="btn btn-default btn-flat">ลงชื่อออก</a>
                </div>
              </li>
            </ul>
          </li>
        ...
        <div class="col-md-7">
          ...
          <div class="box box-primary">
              ...
              <div class="row" >
                ...
                <?php if(isset($sales_id)): ?>
                  ...
                  <div class="col-md-4 pull-right">
                    <a href='<?= $base_url;?>pos' class="btn btn-primary pull-right">เปิดบิลใหม่</a>
                  </div>
                  <?php } ?>
                <?php endif; ?>
            ...
            <!-- /.box-header -->
              ...
              <input type="hidden" id="base_url" value="<?php echo $base_url;; ?>"><input type="hidden" id="store_vat_no" value="<?php echo get_store_details()->vat_no; ?>">
              ...
              <input type="hidden" value='' id="tot_disc" name="tot_disc">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">ตั้งค่าส่วนลด</h4>
                    </div>
                          ...
                          <div class="col-md-6">
                            <div class="box-body">
                              <div class="form-group">
                                <label for="discount_input">ส่วนลด</label>
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" class="btn btn-primary discount_update">อัพเดท</button>
                    </div>
                  </div>
                  <!-- /.modal-content -->
                </div>
            ...
            <!-- Store Code end -->
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    <div class="col-sm-sm" style="overflow-y:auto;height: 300px;border:1px solid rgb(74, 9, 194);" >
                      <table class="table table-condensed table-bordered  table-responsive items_table">
                        <thead class="bg-success">
                          <th width="30%" class='text-center'><?= $this->lang->line('item'); ?></th>
                        <th width="10%" class='text-center'><?= $this->lang->line('stock'); ?></th> 
                          <th width="15%" class='text-center'><?= $this->lang->line('quantity'); ?></th>
                          <th width="10%" class='text-center'><?= $this->lang->line('price'); ?></th>
                    <!--   <th width="5%" class='text-center'><?= $this->lang->line('discount'); ?>(<?=$CI->currency()?>)</th>-->
                         <th width="5%" class='text-center'><?= $this->lang->line('discount'); ?></th>
                          <th width="5%" class='text-center'><?= $this->lang->line('tax'); ?></th>
                          <th width="20%" class='text-center'><?= $this->lang->line('amount'); ?></th>
                          <th width="5%"><i class="fa fa-close"></i></th>
                        </thead>
                        <tbody id="pos-form-tbody" style="font-size: 14px;font-weight: bold;overflow: scroll;">
                          <!-- body code -->
                        </tbody>        
                        <tfoot>
                          <!-- footer code -->
                 ...
                 <!-- SMS Sender while saving -->
                    ...
                    <div class="col-sm-8 col-xs-12">
                          <div class="form-group">
                                          ...
                                          <label for="other_charges_input" class="col-sm-3 col-xs-3 control-label"><?= $this->lang->line('other_charges'); ?></label> 
                                          ...
                                          <div class="col-sm-3 col-xs-3">
                                             <select class="form-control " id="other_charges_tax_id" name="other_charges_tax_id" onchange="final_total();" style="width: 100%;">
                                                <?= get_tax_select_list((isset($other_charges_tax_id) ? $other_charges_tax_id : ''),get_current_store_id());?>
                                             </select>
                                          </div>
                   ...
                   <div class="col-sm-4 col-xs-6">
                       <div class="input-group">
                            <span class="input-group-addon"><?= $this->lang->line('date'); ?></span>
                             <input type="text" class="form-control" id="sales_date" name="sales_date" placeholder="Sales Date" readonly value="<?php echo isset($sales_date) ? $sales_date : ''; ?>">
                        </div>
                   </div>
                   <div class="col-sm-4">
              ...
              <div class="box-footer bg-gray">
                <div class="row">
                  <div class="col-sm-3 col-xs-2 text-right ">
                          ...
                          <span  style="font-size: 19px;"  class="text-bold tot_qty"></span>
                  </div>
                 <div class="col-sm-3 col-xs-3 text-right ">
                    ...
                    <div class="col-sm-3 col-xs-3 text-right ">
                          <label><?= $this->lang->line('other_charges'); ?>:</label><br>
                          <?= $CI->currency('<span style="font-size: 19px;" class="tot_other_charges text-bold"></span>');?>
                  </div>
                  <div class="col-sm-3 col-xs-4 text-right">
                          <label><?= $this->lang->line('discount_pos'); ?>:<a class="fa fa-pencil-square-o cursor-pointer" data-toggle="modal" data-target="#discount-modal"></a></label><br>
                          <?= $CI->currency('<span style="font-size: 19px;" class="tot_disc text-bold"></span>');?>
                  </div>
                  <div class="col-sm-12 col-xs-12 text-right">
                          <label><?= $this->lang->line('grand_total'); ?> : </label>
                          <?=  $CI->currency('<span style="font-size: 46px; color:red;" class="tot_grand text-bold"></span>');?>
                  </div>
                </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-12 text-right">
                    ...
                    <div class="col-sm-4 " style="margin-bottom:5px">
                      <button type="button" id="hold_invoice" name="" class="btn bg-primary btn-block btn-flat btn-lg btnhold" title="Hold Invoice [Alt+H]" style="">
                      <i class="fa fa-hand-paper-o" aria-hidden="true"></i>
                       พักบิล alt+h
                    </button>
                    </div>
                    <div class="col-sm-4 " style="margin-bottom:5px">
                      <button type="button" id="" name="" class="btn bg-maroon btn-block btn-flat btn-lg show_payments_modal" title="Multiple Payments [Alt+M]" style="">
                    ...
                    <div class="col-sm-4">
                      <button type="button" id="pay_all" name="" class="btn btnhold btn-success btn-block btn-flat btn-lg Alt_a" title="บันทึกและจ่ายเงินสด [Alt+A]" style="">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="input-group input-group-md">
                      ...
                      <input type="text" class="form-control" data-toggle="tooltip" title="Enter Item Name" placeholder="ค้นหาชือสินค้า" id="item_name" name="item_name">
                   ...
                   <!--  <div class="col-sm-12"> -->
                      <!-- <style type="text/css">
                            ...
                            <section class="content .sec_div" >
                              <div class="row search_div" style="overflow-y: scroll;min-height: 100px;height: 580px">
                              </div>
                              <h4 class='text-danger text-center error_div' style="display: none;"> </h4>
                            </section>
...
function addrow(id='',item_obj=''){
    ...
    var str=' <tr id="row_'+rowcount+'" data-row="0" data-item-id='+item_id+'>';/*item id*/
       ...
       str+='<td id="td_'+rowcount+'_1">'+ stock +'</td>';/* td_0_1 item available qty  จำนวนคงเหลือ*/
...
function final_total() {
  ...
  var total_global_discount = (discount_to_all * 100) / (100 + max_tax_rate);
...
function set_total(tot_qty=0, tot_amt=0, tot_disc=0, tot_grand=0, tot_other_charges=0){
  $(".tot_qty   ").html(tot_qty);
  $(".tot_amt   ").html(to_Fixed(tot_amt));
  $(".tot_disc  ").html(to_Fixed(tot_disc));
  $(".tot_other_charges").html(to_Fixed(tot_other_charges));
...
function adjust_payments(){
  ...
  for (var i = 1; i <=payments_row; i++) {
    if(document.getElementById("amount_"+i)){
      ...
      paid_amount += isNaN(amount) ? 0 : amount;
    }
  }
  
  // CRITICAL: Trust final_total results for Grand Total components
  var grand_total = parseFloat($(".tot_grand").text().replace(/,/g, '')) || 0;
  var other_charges_amt = parseFloat($(".tot_other_charges").text().replace(/,/g, '')) || 0;
  var discount_amt = parseFloat($(".tot_disc").text().replace(/,/g, '')) || 0;
  var coupon_amt = parseFloat($("#coupon_discount_amt").val()) || 0;

  var change_return = 0;
  var balance = grand_total - paid_amount;
  ...
  $(".sales_div_tot_qty").html(to_Fixed(item_qty));
  ...
  $(".sales_div_tot_payble").html(to_Fixed(grand_total)); 
...
function adjust_payments_OLD(){
  ...
  if(other_charges_input!='' && other_charges_input!=0){
      other_charges_input = parseFloat(other_charges_input);
      if(other_charges_type=='Percentage'){
          other_charges_amt = (total * other_charges_input)/100;
      }else{
          other_charges_amt = other_charges_input;
      }
      
      var other_charges_tax_amt = 0;
      if(other_charges_tax_id>0){
          other_charges_tax_amt = (other_charges_tax_id * other_charges_amt)/100;
      }
      other_charges_total_amt = other_charges_amt + other_charges_tax_amt;
  }

  //2. Add to Total -> Gross Total
  var gross_total = total + other_charges_total_amt;

  //3. Calculate Coupon
  var coupon_amt = discount_coupon_tot(gross_total);
      gross_total -= coupon_amt; //Reduce from base

  //4. Calculate Discount
  var discount_amt=0;
  if(gross_total>0){
    var discount_amt=calulate_discount(discount_input,discount_type,gross_total);//return value 
  }
 
  var subtotal = gross_total-discount_amt; //Grand Total
  ...
  $(".sales_div_tot_amt").html((to_Fixed(total)));
  $(".sales_div_tot_discount").html((to_Fixed(discount_amt))); 
  $(".sales_div_tot_other_charges").html((to_Fixed(other_charges_total_amt))); //Display Other Charges
  $(".coupon_discount_div_amt").html((to_Fixed(coupon_amt))); 
...
$(document).ready(function(){
 ...
 <?php if(isset($sales_id) && !empty($sales_id)){ ?>
    ...
    $.get("<?php echo $base_url ?>pos/fetch_sales/<?php echo $sales_id ?>",{},function(result){
      ...
      $('#discount_input').val(result[1]);
      $('#discount_type').val(result[2]);
      $('#sales_note').val(result[6]);
      $('#reference_no').val(result[8]);
      $('#sales_date').val(result[9]);
 ...
 <?php } elseif(isset($sell_again_id) && !empty($sell_again_id)){ ?>
    $(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
    $.get("<?php echo $base_url ?>pos/fetch_sales/<?php echo $sell_again_id ?>",{},function(result){
      console.log(result);
...
$("#reference_no").autocomplete({
    source: function(data, cb){
        $.ajax({
            autoFocus:true,
            url: '<?php echo base_url('pos/get_sales_suggestions') ?>',
            method: 'GET',
            dataType: 'json',
            data: {
                term: data.term
    ...
    select: function (e, ui) { 
        if(ui.item.value != ''){
            $("#sales_date").val(ui.item.sales_date);
        }
    }
});
