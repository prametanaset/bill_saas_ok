            ...
            <div class="box-header with-border">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                       <label for="payment_from_date"><?=$this->lang->line('from_date');?> </label>
                       <div class="input-group date">
                          <div class="input-group-addon">
                          <i class="fa fa-calendar"></i>
                          </div>
                          <input type="text" class="form-control pull-right datepicker" id="payment_from_date" name="payment_from_date" onchange="load_datatable_with_destroy()">
                       </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                       <label for="payment_to_date"><?=$this->lang->line('to_date');?> </label>
                       <div class="input-group date">
                          <div class="input-group-addon">
                          <i class="fa fa-calendar"></i>
                          </div>
                          <input type="text" class="form-control pull-right datepicker" id="payment_to_date" name="payment_to_date" onchange="load_datatable_with_destroy()">
                       </div>
                    </div>
                  </div>
...
<script src="<?php echo $theme_link; ?>js/pdfmake-thai.js"></script>
<!-- bootstrap datepicker -->
...
<script type="text/javascript">
            ...
            buttons: {
              ...
              //    { extend: 'copy', className: 'btn bg-teal color-palette btn-flat',footer: true, exportOptions: { columns: [0,1,2,3,4,5,6,7,8]} },
               ...
               /* { 
                    ...
                    customize: function(doc) {
                        ...
                        // Set column widths to equal percentage to fill the page
                        var colCount = new Array(9).fill('*'); 
              ...
              "ajax": {
                  ...
                  "data": function (d) {
                      ...
                      d.payment_from_date = $("#payment_from_date").val();
                      d.payment_to_date = $("#payment_to_date").val();
                    },
      ...
      $("#payment_from_date, #payment_to_date").on("change",function(){
          load_datatable_with_destroy();
      });
