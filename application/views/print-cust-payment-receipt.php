...
<body onload="window.print();"><!--   -->
    ...
    // (Removed db_country and db_states queries since the customer address is not displayed on the receipt)
    ...
    // Address Lookup Logic for Store
    $city_name = '';
    $state_name = '';
    $country_name = '';
    $is_bangkok = false;
    ...
    if (!empty($state_name)) $address_parts[] = $state_name;
    if (!empty($country_name)) $address_parts[] = $country_name;
    
    $full_city_custom = implode(' ', $address_parts);
