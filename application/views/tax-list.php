        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-success" href="<?php echo $base_url; ?>tax/add">
       ...
       <!-- <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <?php if($CI->permissions('tax_add')) { ?>
              <div class="box-tools">
                <a class="btn btn-block btn-success" href="<?php echo $base_url; ?>tax_group/add">
...
<script src="<?php echo $theme_link; ?>js/tax.js?v=<?= time(); ?>"></script>
