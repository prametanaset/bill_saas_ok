...
<?php
    ...
    $q3=$this->db->query("SELECT a.supplier_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           b.purchase_code,b.purchase_note,b.purchase_status,b.vat,
...
<table autosize="1" style="overflow: wrap" id='mytable' align="center" width="100%" height='100%' cellpadding="0" cellspacing="0">
                  ...
                  <table style="width: 100%;" class="style_hidden fixed_table">
                    <tr>
                      <td colspan="6" class="text-left" style="color:blue; font-size:36px; font-weight: 700;">
                        <?php echo $this->lang->line('purchase_invoice'); ?> 
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="6">
                        <?php echo $this->lang->line('approver'); ?>:
                        <span style="font-size: 18px;">
  ...
  <tbody style="border-bottom: 2px solid #0070C0;">
    <?php
      ...
      $this->db->select("a.description,c.item_name, a.purchase_qty, a.price_per_unit, b.tax, b.tax_name, a.tax_amt, a.discount_amt, a.unit_total_cost, a.total_cost, d.unit_name");
    ...
    <?php if ($tot_discount_to_all_amt != 0) { ?>
      <tr>
        <td colspan="12" class='text-right'><b><?= $this->lang->line('discount_on_sale'); ?></b></td>
    ...
    <tr>
      ...
      <td colspan="4" class='text-right'><b><?php echo store_number_format($total_vatable); ?></b></td>
    </tr>
    <tr>
      <td colspan="12" class='text-right'><b><?= $this->lang->line('vat_amount') . " " . store_number_format($vat_no) . " % "; ?></b></td>
      <td colspan="4" class='text-right'><b><?php echo store_number_format($vat_amt); ?></b> </td>
    </tr>
     <?php } ?>
        ...
        <table width="100%" class="style_hidden fixed_table">
          <tr>
            <td colspan="8">
              ...
              <span style="font-size: 13px;"><b><?php echo $purchase_note; ?></b></span>
              <br>
            </td>
