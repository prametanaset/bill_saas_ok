...
<html>
   ...
   <body class="hold-transition skin-blue sidebar-mini">
                           ...
                           <table class="table table-bordered table-hover " id="report-data" >
                              <thead>
                                 <tr class="bg-success">
                                    ...
                                    <?php } ?>
                                    <th style="text-align: center;"><?= $this->lang->line('purchase'); ?> <br><?= $this->lang->line('invoice_no'); ?></th>
                                    <th style="text-align: center;"><?= $this->lang->line('payment_date'); ?></th>
                                    <th style="text-align: center;"><?= $this->lang->line('supplier_id'); ?></th>
                                    <th style="text-align: center;"><?= $this->lang->line('supplier_name'); ?></th>
                                    <th style="text-align: center;"><?= $this->lang->line('payment_type'); ?></th>
                                    <th style="text-align: center;"><?= $this->lang->line('payment_note'); ?></th>
                                    <th style="text-align: center;"><?= $this->lang->line('paid_amount'); ?>(<?= $CI->currency(); ?>)</th>
                                 </tr>
                              </thead>
                              <tbody id="tbodyid">
                              </tbody>
      ...
      <script type="text/javascript">
         ...
         if(from_date == "")
             {
                 toastr["warning"]("เลือกรูปแบบวันที่!");
