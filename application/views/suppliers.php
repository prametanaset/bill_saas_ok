                        ...
                        <div class="box-body">
                           ...
                           <div class="row">
                              <div class="col-md-5">
                                 ...
                                 <?php if(gst_number()) {?>
                                 <div class="form-group">
                                    <label for="gstin" class="col-sm-4 control-label"><?= $this->lang->line('tax_id'); ?></label>
                                    <div class="col-sm-8">
                              ...
                              <div class="form-group hide">
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" class="form-control" id="tax_number" name="tax_number" placeholder=" รหัสสาขา  00000 " value="<?php print $tax_number; ?>" >
