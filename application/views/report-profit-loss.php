                     ...
                     <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                           <table class="table table-bordered table-hover " id="report-data-2" >
                              <tr>
                                 <td><?= $this->lang->line('sales_profit'); ?> (Net Sales)</td>
                                 <td class="text-right text-bold sales_profit"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                               <tr>
                                 <td>(+) <?= $this->lang->line('debit_profit'); ?> (Profit)</td>
                                 <td class="text-right text-bold debit_profit"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                               <tr>
                                 <td>(-) <?= $this->lang->line('sales_return'); ?>(ReturnProfit)</td>
                                 <td class="text-right text-bold return_profit_loss"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                              <!-- Total Gross Profit -->
                              <tr class="bg-gray">
                              ...
                              <tr>
                                 <td><?= $this->lang->line('payment_profit'); ?></td>
                                 <td class="text-right text-bold tot_payment"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                           </table>
                        </div>
                        <!-- /.box-body -->
                           ...
                           <table class="table table-bordered table-hover " id="report-data" >
                             ...
                             <tr>
                               ...
                               <tr>
                                  ...
                                  <td class="text-right text-bold closing_stock_price_sales"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                               </tr> 
                              <tr>
                              ...
                              <tr>
                                 ...
                                 <td class="text-right text-bold text-success total_purchase_amt"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                              ...
                              <tr>
                                 ...
                                 <td class="text-right text-bold text-success pur_total bg-success"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                            ...
                            <tr>
                              ...
                              <!-- Total Purchase return all -->
                              <tr>
                                 <td><?= $this->lang->line('total_purchase_return_all'); ?></td>
                                 <td class="text-right text-bold text-success pur_return_total_all bg-success"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                     ...
                     <div class="box">
                           ...
                           <table class="table table-bordered table-hover " id="report-data-4" >
                            <tr>
                              ...
                              <tr>
                                 ...
                                 <td class="text-right text-bold exp_total bg-gray"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                              ...
                              <tr>
                                 ...
                                 <td class="text-right text-bold text-success total_sale"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                            ...
                            <tr>
                              ...
                              <tr>
                                 ...
                                 <td class="text-right text-bold sales_discount_amt bg-info"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                              <!-- Total Sales Tax -->
                               <tr>
                              ...
                              <tr>
                                 ...
                                 <td class="text-right text-bold text-success sal_total bg-success"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                        ...
                        <!--    sales return       -->
                              ...
                              <tr>
                                 ...
                                 <td class="text-right text-bold sale_return_total"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                            ...
                            <tr>
                                 <td><?= $this->lang->line('total_tax_return'); ?></td>
                              ...
                              <tr>
                                 ...
                                 <td class="text-right text-bold text-success sal_return_total bg-success"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                              <!-- Total Sales return Paid Amount -->
                              <tr>
                                 <td><?= $this->lang->line('paid_amount'); ?></td>
                              ...
                              <tr>
                                 <td colspan="2" class="text-bold font-italic text-primary"><?= $this->lang->line('sales_debit'); ?></td>
                              </tr>
                              <!-- Total sales debit -->
                              <tr>
                                 <td><?= $this->lang->line('total_sales_debit'); ?></td>
                                 <td class="text-right text-bold sale_debit_total"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>

                                 <!-- Total Sales debit Other Charges -->
                              <tr>
                                 <td><?= $this->lang->line('total_other_charges_of_sales_debit'); ?></td>
                                 <td class="text-right text-bold sal_debit_other_charges_amt"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>

                                <!-- Total Sales debit Doscount -->
                              <tr>
                                 <td><?= $this->lang->line('total_discount_on_sales_debit'); ?></td>
                                 <td class="text-right text-bold sales_debit_discount_amt"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>

                              <!-- Total sales debit Tax -->
                            <tr>
                                 <td><?= $this->lang->line('total_tax_debit'); ?></td>
                                 <td class="text-right text-bold sales_debit_tax_amt"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr> 
                                                    
                            
                              <!-- Total Sales debit Paid Amount -->
                              <tr>
                                 <td><?= $this->lang->line('debit_total'); ?></td>
                                 <td class="text-right text-bold text-success sal_debit_total bg-success"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                              <!-- Total Sales debit Paid Amount -->
                              <tr>
                                 <td><?= $this->lang->line('paid_amount'); ?></td>
                                 <td class="text-right text-bold text-success sales_debit_paid_amount"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                              <!-- Total Sales debit Due -->
                              <tr>
                                 <td><?= $this->lang->line('sales_debit_due'); ?></td>
                                 <td class="text-right text-bold text-danger sales_debit_due_total"><?php echo $CI->currency(number_format(0,2,'.','')); ?></td>
                              </tr>
                           </table>
                        </div>
                        <!-- /.box-body -->
