  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      $q3 = $this->db->query("SELECT b.coupon_id,b.coupon_amt,b.store_id,b.sales_id,a.customer_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           b.return_code,b.return_status,b.return_note,b.vat,b.taxable_amount,b.vat_amt,
      ...
      $total_in_tax = $res3->subtotal; // กำหนดค่า subtotal ให้เป็น $total_in_tax
      ...
      if (!empty($sales_id)) {
          ...
          if ($ref_q && $ref_q->num_rows() > 0) {
              ...
              if ($ref_raw == 'tax_invoice') {
                  $return_reference_type = 'ใบกำกับภาษี';
              } elseif ($ref_raw == 'tax_receipt') {
                  $return_reference_type = 'ใบเสร็จรับเงิน/ใบกำกับภาษี';
              }
          }
      }
      ...
      <section class="invoice">
        ...
        <div class="printableArea">
         ...
         <!--  <ins><?= $this->lang->line('from'); ?></ins> -->
            ...
            <?php if(!isset($return_reference_type)) $return_reference_type = ''; ?>
           </address>
            </div>
            ...
            <!-- /.col -->
             <div class="col-sm-4 invoice-col">
                   ...
                   <b><?= $this->lang->line('status'); ?> : <?php echo  $return_status; ?></b><br>
             
                    <?php if ($sales_code) { ?>
                   <b style="color:blue;"><?= $this->lang->line('returned_against_sales_invoices'); ?>  :   <?php echo  $sales_code; ?></b><br>
                   <?php } ?>

                     <b><?= $this->lang->line('reference_type'); ?> : <?php echo  $return_reference_type; ?></b><br>
                   ...
                   <!--   <?php if(!empty($tot_price_zero_vat !=0)) {?>
                    ...
                    <tr class='text-primary'>
                          <th class="text-right" style="font-size: 17px;"><b><?= $this->lang->line('total_against_sales_invoices') ; ?></b></th>
                            <th class="text-right" style="padding-left:10%;font-size: 17px;">
                            <h4><b id="total_amt" name="total_amt"><?=store_number_format($ref_total );?></b></h4>
                            </th>
                        </tr> 
                       <tr class='text-primary'>
        ...
        <div class="col-xs-6">
         ...
         <tr style="margin-top: 5 px">
            <?php if ($CI->permissions('sales_edit')) { ?>
              ...
              <a href="<?php echo $base_url; ?><?= $str2; ?><?php echo  $return_id ?>" class="btn btn-warning" style="margin-bottom:5px; margin-right: 15px; margin-bottom:10px;">
           ...
           <tr style="margin-top: 5 px">
            ...
            <a href="javascript:void(0);" onclick="printTemplate('<?php echo $base_url; ?>sales_return/print_invoice/<?php echo $return_id; ?>')" class="btn btn-success" style="margin-bottom:5px; margin-right: 15px; margin-bottom:10px;">
              <i class="fa fa-print"></i> พิมพ์ใบคืนสินค้า
            </a>
            
          <a href="<?php echo $base_url; ?>sales_return/pdf_a3/<?php echo  $return_id ?>" target="_blank" class="btn btn-primary" style="margin-bottom:5px; margin-right: 15px; margin-bottom:10px;">
