...
<?php
     ...
     $q3=$this->db->query("SELECT b.coupon_id,b.coupon_amt,b.store_id,b.sales_id,a.customer_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                            ...
                            b.return_code,b.return_status,b.return_note,b.taxable_amount,b.vat_amt,b.vat,
     ...
     $res10x = $q10x->row();
     $previous_grand_total = $res10x->total_amount;
...
<span style="color:#0070C0; font-size:34px; font-weight: 800;">
    <?= $this->lang->line('sale_return_invoice') ?>
  </span>
</div>
...
<!-- <table align="center" width="100%" height='100%'   > -->
                       ...
                       <tr>                        
                         <td colspan="6">
                          <div class="form-group">   
                             ...
                             <label for="return_note" class="col-sm-4 control-label" style="font-size: 18px;"><?= $this->lang->line('return_note'); ?></label>    
                             <span style="font-size: 22px;">  
                               <label class="control-label " style="font-size: 20px;">: <?= $return_note;?></label>
                              </span>                                                          
                         </div>
                         </td>                      
                       </tr>  
    ...
    <tbody style="border-bottom: 2px solid #0070C0;">
      ...
      <tr>
        ...
        <!--  <tr>
            <td colspan="13" class='text-right'><b><?= $this->lang->line('subtotal'); ?></b></td>
