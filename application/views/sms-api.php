                                  ...
                                  <div class="callout callout-info">
                                    <h4>HTTP/URL</h4>
                                      <p>
                                        ...
                                        <br>
                                        หมายเหตุ: คุณต้องตรวจสอบรหัสข้อความและรหัสหมายเลขโทรศัพท์มือถือจาก API ของคุณ ผู้ให้บริการ SMS แต่ละรายอาจมีรหัส ที่แตกต่างกัน<br>
                                        ในตัวอย่างด้านบน รหัส 'ข้อความ' และ 'โทรศัพท์มือถือ' ของ API หมายถึงข้อความและหมายเลขโทรศัพท์มือถือ ซึ่งคุณต้องเปลี่ยนค่าของข้อความและหมายเลขโทรศัพท์ .
                                        <br>
                                        <u>ตัวอย่าง:</u>
                                        <ol>
                                          <li>URL : https://www.example.com/api/mt/SendSMS</li>
                                          <ul>
                                             <li>หมายเหตุ: (อย่าใส่เครื่องหมายคำถาม ? ลงในช่องป้อนข้อมูล) </li>
                                          </ul>
                                        ...
                                        นี่เป็นเพียงตัวอย่าง ผู้ให้บริการ SMS แต่ละรายอาจมีแอตทริบิวต์ที่แตกต่างกัน ซึ่งคุณจะต้องกำหนดแอตทริบิวต์ดังกล่าว .
