     ...
     <!--<div class="row">
       ...
       <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="info-box " >
            ...
            <div class="info-box-content">
              <span class="info-box-text" ><?=$CI->currency(($tot_received_amt));?></span>
            ...
            <div class="box-header with-border">
              ...
              <div class="row">
                ...
                <div class="col-md-2 pull-right">
                  ...
                  <div class="box-tools">
                <a class="btn btn-block btn-success" href="<?php echo $base_url; ?>sales/add">
            ...
            <div class="box-body ">
              <table id="example2" class="table custom_hover " width="100%">
                ...
                <tr >
                  ...
                  <th><?=$this->lang->line('reference_sales');?></th>
                  <th><?=$this->lang->line('reference_tax_type');?></th>
      ...
      function load_datatable(){
       ...
       /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api.column( 8 ).footer() ).html(to_Fixed(tax));
            $( api.column( 9 ).footer() ).html(to_Fixed(paid));
