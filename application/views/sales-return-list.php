            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="return_from_date"><?= $this->lang->line('from_date'); ?> </label>
                    <div class="input-group date">
                      <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                      </div>
                      <input type="text" class="form-control pull-right datepicker" id="return_from_date" name="return_from_date" onchange="load_datatable_with_destroy()">
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="return_to_date"><?= $this->lang->line('to_date'); ?> </label>
                    <div class="input-group date">
                      <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                      </div>
                      <input type="text" class="form-control pull-right datepicker" id="return_to_date" name="return_to_date" onchange="load_datatable_with_destroy()">
                    </div>
                  </div>
                </div>
              </div>
              <table id="example2" class="table table-bordered custom_hover" width="100%">
                ...
                <tr>
                  ...
                  <th  class='text-center'><?= $this->lang->line('return_code'); ?></th>
                  <th  class='text-center'><?= $this->lang->line('return_note'); ?></th>
                  <th  class='text-center'><?= $this->lang->line('difference_return'); ?></th>
                  <th  class='text-center'><?= $this->lang->line('customer_name'); ?></th>
                  <!-- <th>Warehouse</th> -->
                  <th  class='text-center'><?= $this->lang->line('total_correct_amt'); ?></th>
                  <th  class='text-center'><?= $this->lang->line('return_payment'); ?></th>
...
<script type="text/javascript">
              ...
              },
              {
               ...
               /*Start Footer Total*/
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    $( api.column( 5 ).footer() ).html(to_Fixed(diff_return));
      ...
      $("#return_from_date, #return_to_date").on("change",function(){
          load_datatable_with_destroy();
      });
</script>
