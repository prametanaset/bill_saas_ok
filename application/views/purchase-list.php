...
.info-box-number {
  ...
  <!-- ********** ALERT MESSAGE START******* -->
                              ...
                              <div class="col-md-3">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                       ...
                                       <input type="text" class="form-control pull-right datepicker" id="purchase_from_date" name="purchase_from_date" onchange="load_datatable_with_destroy()">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-3">
                                 <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                       ...
                                       <input type="text" class="form-control pull-right datepicker" id="purchase_to_date" name="purchase_to_date" onchange="load_datatable_with_destroy()">
                                    </div>
                                 </div>
                              </div>
                           </div>
               ...
               buttons: {
                 ...
                 "ajax": {
                     ...
                     "data": {
                      ...
                      purchase_from_date: $("#purchase_from_date").val(),
                      purchase_to_date: $("#purchase_to_date").val(),
                    },
      ...
      $("#purchase_from_date, #purchase_to_date").on("change",function(){
          load_datatable_with_destroy();
      });
      </script>
