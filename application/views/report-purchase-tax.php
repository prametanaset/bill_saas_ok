                           ...
                           <table class="table table-bordered table-hover " id="report-data" >
                              <thead>
                                 <tr class="bg-success">
                                   ...
                                   <th class='text-right'><?= $this->lang->line('discount_amount'); ?></th>
                                    <th class='text-center'><?= $this->lang->line('tax'); ?></th> 
                                                           
                                    <th class='text-right'><?= $this->lang->line('tax_amount'); ?></th>
                              
                                    <th class='text-right'><?= $this->lang->line('invoice_total'); ?></th>
                                 </tr>
                              </thead>
                              <tbody id="tbodyid">
                              </tbody>
