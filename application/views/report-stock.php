                                       ...
                                       <input type="hidden" id="base_url" value="<?php echo $base_url;; ?>">
                                          ...
                                          <table class="table table-bordered table-hover " id="report-data" >
                                            ...
                                            <tr class="bg-success">
                                              ...
                                              <?php } ?>
                                              <th class='text-center'><?= $this->lang->line('item_code'); ?></th>
                                              <th class='text-center'><?= $this->lang->line('item_name'); ?></th>
                                              <th class='text-center'><?= $this->lang->line('brand'); ?></th>
                                              ...
                                              <th class='text-center'><?= $this->lang->line('purchase_cost'); ?></th>
                                              <th class='text-center'><?= $this->lang->line('sales_price'); ?></th>
                                              <th class='text-center'><?= $this->lang->line('current_stock'); ?></th>
                                          ...
                                          <table class="table table-bordered table-hover " id="brand_wise_stock" >
                                              ...
                                              <tr class="bg-success">
                                                ...
                                                <?php if(store_module() && is_admin()){ ?>
                                                  <th style=""><?= $this->lang->line('store_name'); ?></th>
                                                  <?php } ?>
                                                <th class='text-center' style=""><?= $this->lang->line('brand_name'); ?></th>
                                                
                                                <th class='text-center' style=""><?= $this->lang->line('current_stock'); ?></th>
                                              </tr>
                                              </thead>
                                              <tbody id="">
