  ...
  <div class="modal-dialog modal-lg">
    ...
    <?php 
     ...
     if($atleast_one_payments=='true'){ ?>
        ...
        <div class="row">
               <div class="col-md-12">
                  <div class="">
                    <label for="payment_note_1"><?= $this->lang->line('บันทึก'); ?></label>
    ...
    <?php } ?>
      ...
      <div class="row">
              ...
              <div class="col-md-12">
              <div class="col-md-12">
                <button type="button" class="btn btn-primary btn-block" id="add_payment_row">เพิ่มการชำระเงิน</button>
              </div>
              </div>
            </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="">
                    <label for="sales_note"><?= $this->lang->line('payment_note'); ?></label>
              ...
              <div class="box-body">
                <div class="row bg-success">
                  <div class="col-md-12 border-custom-bottom">
                    <span class="col-md-6 text-right text-bold ">จำนวน:</span>
                ...
                <div class="row bg-success">
                  <div class="col-md-12 border-custom-bottom">
                    <span class="col-md-6 text-right text-bold ">รวมเงิน:</span>
                ...
                <!--  -->
                   <div class="row bg-success">
                  <div class="col-md-12 border-custom-bottom">
                    <span class="col-md-6 text-right text-bold ">ค่าบริการ(+):</span>
                    <span class="col-md-6 text-right text-bold  custom-font-size sales_div_tot_other_charges">0.00</span>
                  </div>
                </div>
                <!--  -->
                <div class="row bg-success">
                  <div class="col-md-12 border-custom-bottom">
                    <span class="col-md-6 text-right text-bold ">ส่วนลด(-):</span>
                ...
                <div class="row bg-blue">
                  <div class="col-md-12 border-custom-bottom" >
                    <span class="col-md-6 text-right text-bold ">ยอดต้องชำระ:</span>
                ...
                <div class="row bg-blue">
                  <div class="col-md-12 border-custom-bottom">
                    <span class="col-md-6 text-right text-bold ">จำนวนจ่าย:</span>
                ...
                <div class="row bg-blue">
                  <div class="col-md-12 border-custom-bottom">
                    <span class="col-md-6 text-right text-bold ">คงเหลือ:</span>
                ...
                <div class="row ">
                  <div class="col-md-12 bg-blue">
                    <span class="col-md-6 text-right text-bold ">เงินทอน:</span>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn bg-maroon btn-lg make_sale btn-lg" onclick="save()"><i class="fa  fa-save "></i>บันทึก</button>
        <button type="button" class="btn btn-success btn-lg make_sale btn-lg" onclick="save(true)"><i class="fa  fa-print "></i> บันทึก & พิมพ์ใบเสร็จ</button>
