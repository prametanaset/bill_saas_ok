...
<header class="main-header">
       ...
       <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
          ...
          <ul class="nav navbar-nav">  
            ...
            <li>                
              ...
              <div class="btn-group hidden-xs">
               <a href="#" class="btn navbar-btn bg-blue dropdown-toggle " data-toggle="dropdown" aria-expanded="false"  style=" margin-left:15px">
        ...
        <?php if(!is_user()){?>
           <div class="btn-group hidden-xs" style="margin-left:15px">
            <a href="#" class="btn navbar-btn bg-blue dropdown-toggle " data-toggle="dropdown" aria-expanded="false" >
            ...
            <li class="report-stock-active-li"><a href="<?php echo $base_url; ?>reports/stock" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('stock_report'); ?></span></h4>
              </a></li>
            <?php } ?>
           

            <?php if($CI->permissions('profit_report')) { ?>
            <li class="report-profit-loss-active-li"><a href="<?php echo $base_url; ?>reports/profit_loss" > <h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('profit_and_loss_report'); ?></span></h4>
              </a></li>
            <?php } ?>
           
            <?php if($CI->permissions('sales_report')) { ?>
            <li class="report-sales-active-li"><a href="<?php echo $base_url; ?>reports/sales" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('sales_report'); ?></span></h4></a></li>
            <?php } ?>
            
            <?php if($CI->permissions('sales_tax_report')) { ?>
            <li class="report-sales-tax-active-li"><a href="<?php echo $base_url; ?>reports/sales_tax" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('sales_tax_report'); ?></span></h4></a></li>
            <?php } ?>
           
            <?php if($CI->permissions('purchase_report')) { ?>
            <li class="report-purchase-active-li"><a href="<?php echo $base_url; ?>reports/purchase" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('purchase_report'); ?></span></h4></a></li>
            <?php } ?>

            <?php if($CI->permissions('purchase_tax_report')) { ?>
            <li class="report-purchase-tax-active-li"><a href="<?php echo $base_url; ?>reports/purchase_tax" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('purchase_tax_report'); ?></span></h4></a></li>
            <?php } ?>


            <?php if($CI->permissions('expense_report')) { ?>
            <li class="report-expense-active-li"><a href="<?php echo $base_url; ?>reports/expense" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span ><?= $this->lang->line('expense_report'); ?></span></h4></a></li>
            <?php } ?>

            <?php if($CI->permissions('purchase_payments_report')) { ?>
            <li class="report-purchase-payments-active-li"><a href="<?php echo $base_url; ?>reports/purchase_payments" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span ><?= $this->lang->line('purchase_payments_report'); ?></span></h4></a></li>
            <?php } ?>
            <?php if($CI->permissions('sales_payments_report')) { ?>
            <li class="report-sales-payments-active-li"><a href="<?php echo $base_url; ?>reports/sales_payments" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('sales_payments_report'); ?></span></h4></a></li>  
            <?php } ?>

            <?php if($CI->permissions('delivery_sheet_report') && false) { ?>
            <li class="report-delivery-sheet-active-li"><a href="<?php echo $base_url; ?>reports/delivery_sheet" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('delivery_sheet_report'); ?></span></h4></a></li>
            <?php } ?>

            <?php if($CI->permissions('load_sheet_report') && false) { ?>
            <li class="report-load-sheet-active-li"><a href="<?php echo $base_url; ?>reports/load_sheet" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('load_sheet_report'); ?></span></h4></a></li>
            <?php } ?>

                   
            <?php if($CI->permissions('customer_orders_report')) { ?>
            <li class="report-customer-orders-active-li"><a href="<?php echo $base_url; ?>reports/customer_orders" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('customer_orders'); ?></span></h4></a></li>
            <?php } ?>

            <?php if($CI->permissions('sales_summary_report')) { ?>
            <li class="report-sales-summary-active-li"><a href="<?php echo $base_url; ?>reports/sales_summary" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('sales_summary_report'); ?><span class="pull-right-container">            
              </span></h4></a></li>
            <?php } ?>
                      
            <?php if($CI->permissions('sales_return_report')) { ?>
            <li class="report-sales-return-active-li"><a href="<?php echo $base_url; ?>reports/sales_return" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('sales_return_report'); ?></span></h4>
              </a></li>
            <?php } ?>

            
            <?php if($CI->permissions('sales_return_payments')) { ?>
            <li class="report-sales-return-payments-active-li"><a href="<?php echo $base_url; ?>reports/sales_return_payments" ><h4><i class="fa fa-bar-chart text-aqua "></i> <span><?= $this->lang->line('sales_return_payments'); ?><span class="pull-right-container">      
              </span></h4></a></li> 
            <?php } ?>

            
            <?php if($CI->permissions('return_items_report')) { ?>
            <li class="report-return-item-active-li"><a href="<?php echo $base_url; ?>reports/return_item" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('return_items_report'); ?></span><span class="pull-right-container">       
              </span></h4></a></li>
            <?php } ?> 
          
            <?php if($CI->permissions('purchase_return_report')) { ?>
            <li class="report-purchase-return-active-li"><a href="<?php echo $base_url; ?>reports/purchase_return" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('purchase_return_report'); ?></span></h4>
              </a></li>
            <?php } ?>
               
            <?php if($CI->permissions('seller_points_report')) { ?>
            <li class="report-seller-points-active-li"><a href="<?php echo $base_url; ?>reports/seller_points" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('seller_points_report'); ?></span></h4></a></li>
            <?php } ?>
                      
            <?php if($CI->permissions('stock_transfer_report')) { ?>
            <li class="report-stock-transfer-active-li"><a href="<?php echo $base_url; ?>reports/stock_transfer" ><h4><i class="fa fa-bar-chart text-aqua"></i> <span><?= $this->lang->line('stock_transfer_report'); ?><span class="pull-right-container"></h4>            
              </span></a></li>
            <?php } ?>
        ...
        <?php if(!is_user() && $CI->permissions('pos')) { ?>
          <a href="<?php echo $base_url; ?>pos" class="btn navbar-btn bg-green dropdown-toggle "  style=" margin-left:15px">
           <i class="fa fa-shopping-cart text-yellow"></i><b>..POS </b></a>
           <?php } ?>
  ...
  <aside class="main-sidebar">
    ...
    <li class="dashboard-active-li "><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard text-aqua"></i> <span><?= $this->lang->line('dashboard'); ?></span></a></li>
     ...
     <li class="sms-active-li sms-templates-list-active-li email-active-li email-logs-active-li email-templates-list-active-li treeview">
          <a href="#">
            <i class="fa fa-envelope text-aqua"></i> <span><?= $this->lang->line('send_email'); ?></span>
          ...
          <ul class="treeview-menu">
           <!-- <?php if($CI->permissions('send_sms')) { ?>
            ...
            <li class="email-logs-active-li"><a href="<?php echo $base_url; ?>email_logs"><i class="fa fa-history "></i> <span>ประวัติการส่งอีเมล</span></a></li>
            <?php } ?>
            <?php if($CI->permissions('email_template_view')) { ?>
    ...
    <!-- <li class="header">SALES</li> -->
      <li class="pos-active-li sales-list-active-li sales-active-li sales-return-active-li sales-return-list-active-li sales-payments-list-active-li treeview">
          <a href="#">
            <i class=" fa fa-shopping-cart text-aqua"></i> <span style="color: "><?= $this->lang->line('sales'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="sales-debit-list-active-li "><a href="<?php echo $base_url; ?>sales_debit"><i class="fa fa-list "></i> <span><?= $this->lang->line('sales_debit_view'); ?></span>
              </a></li>
        <li class="receipts_list-active-li "><a href="<?php echo $base_url; ?>receipts"><i class="fa fa-list "></i> <span><?= $this->lang->line('receipts_list'); ?></span>
              </a></li>
        <li class="invoice_list-active-li "><a href="<?php echo $base_url; ?>invoices"><i class="fa fa-list "></i> <span><?= $this->lang->line('invoice_list'); ?></span>
              </a></li>
        <?php } ?>
    ...
    <!-- <li class="header">QUOTATION</li> -->
        ...
        <li class="list-active-li"><a href="<?php echo $base_url; ?>customers_advance"><i class="fa fa-dollar text-aqua"></i> <span><?= $this->lang->line('advance_list'); ?></span></a></li>
        <?php } ?>

  <!--  <li class="list-active-li create-active-li treeview">
          <a href="#">
            <i class="fa fa-money "></i> <span style="color:  "><?= $this->lang->line('advance'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
    ...
    <!-- <li class="header">QUOTATION</li> -->
      <?php if($CI->permissions('quotation_view')) { ?>
        <li class="quotation_list-active-li"><a href="<?php echo $base_url; ?>quotation"><i class="fa fa-calendar-plus-o text-aqua "></i> <span><?= $this->lang->line('quotation'); ?></span></a></li>
        <?php } ?>
   ...
   <!--
    ...
    <?php if(!is_user()){?>
        ...
        <li class="items-list-active-li items-active-li  category-view-active-li category-active-li brand-active-li brand-view-active-li labels-active-li import_items-active-li services-active-li import_services-active-li variants-active-li variants_list-active-li services-active-li treeview">
          <a href="#">
            <i class="fa fa-cubes text-aqua"></i> <span style="color:"><?= (service_module()) ? $this->lang->line('items') : $this->lang->line('items'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
    ...
    <li class="purchase-list-active-li purchase-active-li purchase-returns-active-li purchase-returns-list-active-li treeview treeview2 ">
          <a href="#">
            <i class="fa fa-cube text-aqua"></i> <span style="color: "><?= $this->lang->line('purchases'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
    ...
    <?php if($CI->permissions('store_view') && store_module() && is_admin()) { ?>
        ...
        <li class="store_list-active-li store-active-li subscribers-active-li subscribers_list-active-li treeview">
          <a href="#">
            <i class="fa fa-home text-aqua"></i> <span style="color: gold;"><?= $this->lang->line('stores'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <?php if(is_admin()){ ?>
            <li class="store-recycle-active-li"><a href="<?php echo $base_url; ?>store/recycle_bin" ><i class="fa fa-trash "></i> <span>Store Recycle Bin</span></a></li>
            <?php } ?>
            <li class="subscription_payments-active-li"><a href="<?php echo $base_url; ?>subscription_payments"><i class="fa fa-money "></i> <span style="color: gold;"><?= $this->lang->line('subscription_payments'); ?></span></a></li>
    ...
    <?php if($CI->permissions('offline_payments_view') || is_admin()) { ?>
        <li class="offline-requests-active-li"><a href="<?php echo $base_url; ?>offline_requests"><i class="fa fa-money text-aqua"></i> <span style="color: gold;">อนุมัติ/สลิปโอนเงิน</span></a></li>
    <?php } ?>
    ...
    <?php if(($CI->permissions('warehouse_view') || $CI->permissions('warehouse_add')) && warehouse_module()) { ?>
            ...
            <li class="warehouse-list-active-li"><a href="<?php echo $base_url; ?>warehouse"><i class="fa fa-building-o text-aqua "></i> <span><?= $this->lang->line('warehouse'); ?></span></a></li>
           <?php } ?>
    ...
    <li class="accounts_list-active-li accounts-active-li journal-active-li journal_list-active-li money_transfer-active-li money_transfer_list-active-li money_deposit-active-li money_deposit_list-active-li cash_transactions-active-li treeview">
          <a href="#">
            <i class="fa fa-th-large text-aqua"></i> <span style="color: "><?= $this->lang->line('accounts'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          ...
          <!--  <?php if($CI->permissions('accounts_add')) { ?>
            ...
            <li class="cash_transactions-active-li"><a href="<?php echo $base_url; ?>accounts/cash_transactions"><i class="fa fa-exchange text-yellow "></i> <span><?= $this->lang->line('cash_transactions'); ?></span></a></li>
            <?php } ?>
    ...
    <li class="report-sales-active-li report-sales-return-active-li report-purchase-active-li report-purchase-return-active-li report-expense-active-li report-stock-active-li report-purchase-payments-active-li report-sales-item-active-li report-sales-payments-active-li report-expired-items-active-li report-supplier_items-active-li report-seller-points-active-li report-sales-tax-active-li report-purchase-tax-active-li  report-delivery-sheet-active-li report-load-sheet-active-li report-return-item-active-li report-sales-active-li report-stock-transfer-active-li reports-menu report-sales-summary-active-li report-sales-return-payments-active-li treeview">
          <a href="#">
            <i class="fa fa-bar-chart text-aqua"></i> <span style="color: "><?= $this->lang->line('reports'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <?php if($CI->permissions('sales_debit_report') || $CI->permissions('sales_return_report')) { ?>
            <li class="report-sales-debit-active-li"><a href="<?php echo $base_url; ?>reports/sales_debit" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('sales_debit_report'); ?></span>
              </a></li>
            <?php } ?>
  ...
  <!--  <?php if($CI->permissions('send_sms') || $CI->permissions('send_email') || $CI->permissions('email_template_view') || $CI->permissions('sms_template_view') ) { ?>
    ...
    <li class=" site-settings-active-li  change-pass-active-li dbbackup-active-li  tax-active-li currency-view-active-li  store_profile-active-li currency-active-li  database_updater-active-li tax-list-active-li units-list-active-li unit-active-li payment_types_list-active-li payment_types-active-li gateways-active-li package-active-li subscription-active-li  subscription-list-active-li  package-list-active-li sms-api-active-li smtp-active-li treeview">
          ...
          <!--  <?php if($CI->permissions('sms_api_view')) { ?>
            ...
            <li class="subscription-status-active-li"><a href="<?php echo $base_url; ?>subscription/status"><i class="fa fa-list-alt "></i> <span><?= $this->lang->line('package_list'); ?></span>
              </a></li>
            <?php } ?>

            <?php if(is_admin()) { ?>
            <li class="activity_log-active-li"><a href="<?php echo $base_url; ?>activity_log"><i class="fa fa-history"></i> <span>Activity Log</span></a></li>
            <?php } ?>




            <?php if($CI->permissions('tax_view') || is_admin()) { ?>
            ...
            <?php } ?>
            <?php if($CI->permissions('units_view') || is_admin()) { ?>
            ...
            <?php if($CI->permissions('payment_types_view') || is_admin()) { ?>
