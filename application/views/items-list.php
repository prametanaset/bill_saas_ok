            ...
            <div class="box-header with-border">
              <!-- <h3 class="box-title"><?=$page_title;?></h3> -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label for="item_type" class=" control-label">ประเภทสินค้า</label>
                          <select class="form-control select2" id="item_type" name="item_type"  style="width: 100%;">
                            ...
                            <?php if($CI->permissions('items_view')){?>
                              <option value='Items'>สินค้า</option>
                            <?php } ?>
                            <?php if($CI->permissions('services_view')){?>
                              <option value='Services'>สินค้าบริการ</option>
                            <?php } ?>
                            <option value='Combo'>สินค้าจัดชุด(Combo)</option>
                          </select>
                    </div>
                  <?php }else{ ?>
              ...
              <div class="box-tools">      
                ...
                <a class="btn btn-primary margin" href="<?php echo $base_url; ?>items/add">
                <i class="fa fa-plus " ></i> <?= $this->lang->line('create_item'); ?></a>
                <a class="btn btn-warning margin" href="<?php echo $base_url; ?>items/add?type=Combo">
                <i class="fa fa-plus "></i> สินค้าจัดชุด/ผลิต</a>
                <?php } ?>
