...
<html>
<head>
    <title>Expense Voucher - ใบสำคัญจ่าย</title>
    <style>
...
<div class="container">
    ...
    <div class="header">
        ...
        <h2 style="margin: 5px 0 0; font-weight: bold;"><?= $category->category_name; ?></h2>
    </div>

    <div class="row">
        <div class="col-6">
            <div class="section-title">Paid To (จ่ายเงินให้)</div>
            <strong><?= $expense->expense_for; ?></strong><br>
        </div>
        <div class="col-6 text-right">
            ...
            <table style="width: 100%; border: none;">
                ...
                <tr style="border: none;">
                    ...
                    <td style="border: none; text-align: right; padding: 2px;"><?= show_date($expense->expense_date); ?></td>
                </tr>
                <tr style="border: none;">
                    <td style="border: none; text-align: right; padding: 2px;"><strong>Reference (อ้างอิง):</strong></td>
                    <td style="border: none; text-align: right; padding: 2px;"><?= $expense->reference_no; ?></td>
                </tr>
            </table>
        </div>
    </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <?= $expense->reference_no; ?><br>
                        </td>
                        <td class="text-right"><?= number_format($expense->expense_amt, 2); ?></td>
                    </tr>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="text-right"><strong><?= number_format($expense->expense_amt, 2); ?></strong></td>
                    </tr>
                </tfoot>
            </table>
            <div>
                 <strong>Payment Type (ชำระโดย):</strong> <?= $expense->payment_type; ?>
                 <?php if(!empty($expense->account_id)) { 
                    echo " (Account: " . get_account_name($expense->account_id) . ")"; 
                 } ?>
            </div>
