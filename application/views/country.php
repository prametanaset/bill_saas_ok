            ...
            <form class="form-horizontal" id="country-form" onkeypress="return event.keyCode != 13;">
              ...
              <div class="box-body">
				...
				<div class="form-group">
				  <label for="country_name" class="col-sm-2 control-label"><?= $this->lang->line('country_sub'); ?><label class="text-danger">*</label></label>
                  <div class="col-sm-4">
                ...
                <div class="col-sm-8 col-sm-offset-2 text-center">
                   ...
                   <div class="col-sm-3">
                    <a href="<?=base_url('dashboard');?>">
                      <button type="button" class="col-sm-3 btn btn-block btn-info close_btn" title="Go Dashboard">Close</button>
                    </a>
                   </div>
                </div>
             </div>
