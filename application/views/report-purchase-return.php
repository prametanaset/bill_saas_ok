                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-3">
                                    <div class="input-group date">
                                       ...
                                       <input type="text" class="form-control pull-right datepicker" id="from_date" name="from_date" onkeyup="shift_cursor(event,'to_date')" value="<?php echo show_date(date('d-m-Y', strtotime('-30 days')));?>">
                                    </div>
                           ...
                           <table class="table table-bordered table-hover " id="report-data" >
                              <thead>
                                 <tr class="bg-success">
                                    ...
                                    <th class='text-center'><?= $this->lang->line('purchase_code'); ?></th>
