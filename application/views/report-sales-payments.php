                           ...
                           <table class="table table-bordered table-hover " id="report-data" >
                              <thead>
                                 <tr class="bg-success">
                                    ...
                                    <?php } ?>
                                    <th style="text-align: center;"><?= $this->lang->line('sales'); ?> <br><?= $this->lang->line('invoice_no'); ?></th>
                                    <th style="text-align: center;"><?= $this->lang->line('payment_date'); ?></th>
                                    <th style="text-align: center;"><?= $this->lang->line('customer_id'); ?></th>
                                    <th style="text-align: center;"><?= $this->lang->line('customer_name'); ?></th>
                                    ...
                                    <th style="text-align: center;"><?= $this->lang->line('user'); ?></th>
                                 </tr>
                              </thead>
                              <tbody id="tbodyid">
                              </tbody>
