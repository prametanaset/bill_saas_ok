<!DOCTYPE html>
<html>
<title><?= $page_title;?>- ใบส่งสินค้า</title>
<head>
...
<style>
    @font-face {
        ...
        src: url('file://<?php echo FCPATH; ?>theme/css/fonts-THSarabun/th-sarabun-psk/THSarabun.ttf') format('truetype');
        font-weight: normal;
        font-style: normal;
    }
    @font-face {
        font-family: 'THSarabun';
        src: url('file://<?php echo FCPATH; ?>theme/css/fonts-THSarabun/th-sarabun-psk/THSarabun Bold.ttf') format('truetype');
        font-weight: bold;
        font-style: normal;
    }
    @font-face {
        font-family: 'THSarabun';
        src: url('file://<?php echo FCPATH; ?>theme/css/fonts-THSarabun/th-sarabun-psk/THSarabun Italic.ttf') format('truetype');
        font-weight: normal;
        font-style: italic;
    }
    @font-face {
        font-family: 'THSarabun';
        src: url('file://<?php echo FCPATH; ?>theme/css/fonts-THSarabun/th-sarabun-psk/THSarabun Bold Italic.ttf') format('truetype');
        font-weight: bold;
        font-style: italic;
    }
    ...
    table, th, td {
        ...
        font-family: 'THSarabun', 'Martel Sans', sans-serif;
    }
    th, td {
        padding: 5px;
        text-align: left;   
...
<table align="center" width="100%" height='100%'>
    <thead>
      ...
      <tr>
          <th colspan="5" rowspan="2" style="padding-left: 15px; font-size:14px;">
            ...
            <?php 
                  ...
                  if (!empty($company_city)) {
                      ...
                      if ($q->num_rows() > 0) {
                          ...
                          echo "  " . $prefix . $q->row()->name_in_thai;
                      }
                  }
        ...
        <!--<?php echo (!empty(trim($company_vat_no)) && vat_number()) ? $this->lang->line('vat_number').": ".$company_vat_no."<br>" : '';?> -->
          ...
          <th colspan="5" rowspan="1"><b style="text-transform: capitalize;"><?= $this->lang->line('sales_invoice'); ?> </b></th>
            
      </tr>
      <tr>
          <th colspan="3" rowspan="1" style="font-size: 15px;">
