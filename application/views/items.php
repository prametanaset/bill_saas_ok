  ...
  <!-- </copy> -->  
   ...
   <body class="hold-transition skin-blue  sidebar-mini">
      ...
      <?php
         ...
         $sales_price=$purchase_price=$profit_margin=$unit_id=$price=$alert_qty=$store_id=$q_id="";
         $stock = 0;
         $seller_points =0;
         $custom_barcode ='';
         $description ='';
         ...
         //$variants_selected='';
         $item_group='Single';
         if(isset($item_group_type) && !empty($item_group_type)){
            $item_group=$item_group_type;
         }
                      ...
                      <?= form_open('#', array('class' => 'form', 'id' => 'items-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                        ...
                        <div class="box-body">
                          ...
                          <div class="row">
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <select class="form-control select2" id="item_group" name="item_group"  style="width: 100%;" >
                                     ...
                                     <option <?= ($item_group=='Single') ? 'selected' : '' ?> value="Single">สินค้ามาตรฐาน</option>
                                     <option <?= ($item_group=='Variants') ? 'selected' : '' ?> value="Variants">หลายตัวเลือกย่อย</option>
                                     <option <?= ($item_group=='Combo') ? 'selected' : '' ?> value="Combo">สินค้าจัดชุด(Combo)</option>
                                 </select>
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <select class="form-control select2" id="tax_type" name="tax_type"  style="width: 100%;" >
                                  ...
                                  ?>
                                    <option <?= $inclusive_selected ?> value="Inclusive">Inclusive(รวมภาษี)</option>
                                    <option <?= $exclusive_selected ?> value="Exclusive">Exclusive(ราคาสินค้าไม่รวมภาษี)</option>
                                 </select>
                                 <span id="tax_type_msg" style="display:none" class="text-danger"></span>
                                 
                              </div>
                              <div class="form-group col-md-4 <?= ($item_group=='Variants') ? 'hide' : '' ?>">
                              ...
                              <div class="form-group col-md-4 <?= ($item_group=='Variants') ? 'hide' : '' ?>">
                               ...
                               <div class="form-group col-md-4 <?= ($item_group=='Variants' || $item_group=='Combo') ? 'hide' : '' ?>">
                                 ...
                                 <input type="text" class="form-control only_currency" id="mrp" name="mrp" placeholder="ราคาขายปลีกสูงสุด"  value="<?php print $mrp; ?>" >
                           ...
                           <div class="row variant_div" style="<?= ($item_group=='Variants') ? '' : 'display:none;' ?>">
                             <div class="col-md-12">
                                      ...
                                      <div class="box-body">
                                        ...
                                        <table class="table table-hover table-bordered" style="width:100%" id="variant_table">
                                         ...
                                         <!--     <th rowspan='2' style="width:10%"><?= $this->lang->line('mrp'); ?>(<?= $CI->currency() ?>)</th> -->
                                             ...
                                             <tbody>
                                               <?php if($item_group=='Variants' && !empty($q_id)){ 
                           ...
                           <!-- /row -->
                            ...
                            <div class="row combo_div" style="<?= ($item_group=='Combo') ? '' : 'display:none;' ?>">
                              <div class="col-md-12">
                                   <div class="box box-info ">
                                     <div class="">
                                       <div class="box-header">
                                         <div class="col-md-6 col-md-offset-3 d-flex justify-content" >
                                           <div class="input-group">
                                                 <span class="input-group-addon" title="Select Items"><i class="fa fa-search"></i></span>
                                                  <input type="text" class="form-control " placeholder="Search Product to Add" id="combo_item_search">
                                               </div>
                                         </div>
                                       </div>
                                       <div class="box-body">
                                         <div class="table-responsive" style="width: 100%">
                                         <input type="hidden" value='0' id="current_combo_row_count" name="current_combo_row_count">
                                         <table class="table table-hover table-bordered" style="width:100%" id="combo_table">
                                              <thead class="custom_thead">
                                                 <tr class="bg-primary" >
                                               ...
                                               <tbody>
                                                 <?php if($item_group=='Combo' && !empty($q_id)){ 
                                                    echo $this->items->get_combo_items_in_row($q_id);
                                                  } ?>
                                               </tbody>
                                           </table>
                                       </div>
      ...
      <script type="text/javascript">
        ...
        <?php }?>
         $(document).ready(function() {
            // Delay call to ensure visibility logic runs after plugins (Select2 etc.) are ready
            setTimeout(function() {
        ...
        <?php if(!empty($item_name)){ ?>
          ...
          $("#current_combo_row_count").val($("#combo_table tbody tr").length);
