...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    $q3=$this->db->query("SELECT b.expire_date, b.sales_status, b.store_id,a.customer_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           b.vat, b.vat_amt, b.taxable_amount, b.total_amount
    ...
    $vat_rate = $res3->vat;
    $vat_amt = $res3->vat_amt;
    $taxable_amount = $res3->taxable_amount;
    $total_amount = $res3->total_amount;
    
    // Derived values
    $exempt_amount = round($total_amount - $taxable_amount, 2);
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <small class="pull-right">วันที่ : <?php echo  show_date($quotation_date)." ".$created_time; ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            ...
            <?php echo (!empty(trim($company_gst_no)) && gst_number()) ? $this->lang->line('gst_number').": ".$company_gst_no." - " : '';?> 
             ...
             <?php echo (!empty(trim($company_phone))) ? $this->lang->line('phone').": ".$company_phone."<br>" : '';?>
            <?php echo (!empty(trim($company_mobile))) ? $this->lang->line('mobile').": ".$company_mobile."<br>" : '';?>
        ...
        <div class="col-sm-4 invoice-col">
          ...
          <?php } ?>
          <br>
          <b><?= $this->lang->line('expire_date'); ?> : <?php echo  $expire_date; ?></b><br> <br>
           <b><?= $this->lang->line('quotation_signature'); ?> : <?php echo  $reference_no; ?></b><br>
          ...
          <!--    <th class='text-center'><?= $this->lang->line('discount_amount'); ?></th>-->
            ...
            <tbody>
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  echo "<td class='text-right'>".store_number_format(($res2->price_per_unit * $res2->quotation_qty))."</td>";
               ...
               //   echo "<td class='text-right'>".$res2->tax_name."[".$str."]</td>";
                    ...
                    <table  class="col-md-11">
                       ...
                       <tr >
                          ...
                          <th class="text-right" style="padding-left:10%;font-size: 11px;">
                             <h4><b id="total_exempt" name="total_exempt"><?php echo store_number_format( $tot_discount_to_all_amt);?></b> </h4>
                          </th>
                       </tr>
                       <?php } ?> 

                      <?php if($exempt_amount != 0) {?>
                       <tr >
                          <th class="text-right" style="font-size: 17px;"><?= $this->lang->line('total_zero_vat'); ?></th>
                          <th class="text-right" style="padding-left:10%;font-size: 11px;">
                             <h4><b id="total_exempt" name="total_exempt"><?php echo store_number_format($exempt_amount);?></b> </h4>
                          </th>
                       </tr>
                       <?php } ?> 
                       ...
                       <tr>
                          <th class="text-right" style="font-size: 17px;"><b><?= $this->lang->line('before_amt') ; ?></b></th>
                            ...
                            <h4><b id="total_taxable" name="total_taxable"><?=store_number_format($taxable_amount);?></b>  </h4>
                            <th>
                         </th>
                        </tr>
                      ...
                      <tr>
                        <th class="text-right" style="font-size: 17px;"><b><?= $this->lang->line('vat_amount') . store_number_format($vat_rate) . " % "; ?></b></th>
                        <th class="text-right" style="padding-left:10%;font-size: 17px;">
                          <h4><b id="total_vat_amt" name="total_vat_amt"><?= store_number_format($vat_amt); ?></b></h4>
                        <th>
                        </th>
                      </tr>
                      <?php } ?> 
      ...
      <div class="row no-print">
        <div class="col-xs-6">
          ...
          <a href="<?php echo $base_url; ?><?=$str2;?><?php echo  $quotation_id ?>" class="btn btn-danger" style="margin-bottom:5px; margin-right: 15px; margin-bottom:10px;">
            <i class="fa  fa-edit"></i> แก้ไข
          </a>
         <?php } ?>      
          <?php if($CI->permissions('sales_add') && $sales_status=='') { ?>
            <a href="<?php echo $base_url; ?>sales/quotation/<?php echo  $quotation_id ?>" class="btn btn-success" style="margin-bottom:5px; margin-right: 15px; margin-bottom:10px;">
            <i class="fa  fa-undo"></i> แปลงเป็นการขาย
          </a>
          <?php }else{ ?>
            <a href="<?php echo $base_url; ?>sales/invoice/<?=get_sales_id_of_quotation($quotation_id)?>" class="btn btn-info" style="margin-bottom:5px; margin-right: 15px; margin-bottom:10px;">
            <i class="fa  fa-eye"></i> มุมมองใบเสร็จขาย
          </a>
          <?php } ?>
          
           <a onclick="printTemplate('<?php echo $base_url; ?>quotation/print_invoice/<?php echo  $quotation_id ?>')" target="_blank" class="btn btn-primary" style="margin-bottom:5px; margin-right: 15px; margin-bottom:10px;">
            <i class="fa fa-print"></i> 
          พิมพ์ใบเสนอราคา
         </a>

          <a href="<?php echo $base_url; ?>quotation/pdf/<?php echo  $quotation_id ?>" target="_blank" class="btn btn-primary" style="margin-bottom:5px; margin-right: 15px; margin-bottom:10px;">
