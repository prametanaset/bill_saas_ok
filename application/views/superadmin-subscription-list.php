                                   ...
                                   <table class="table table-striped table-bordered">
                                     ...
                                     <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td><b><?=get_full_address_thai($store_details->address, $store_details->country, $store_details->state, $store_details->city, $store_details->postcode);?></b></td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td><b><?=(isset($subscription_details->subscription_name)) ? $subscription_details->subscription_name : '';?></b></td>
                                      </tr>
                                      <tr>
...
<?php
    ...
    if (isset($subscription_details->expire_date) && $subscription_details->expire_date != '1970-01-01') {
        $day_diff = date_difference($subscription_details->expire_date, date('Y-m-d'));
        $day_diff = abs($day_diff);
        if ($day_diff <= 0) {
            $label_class = 'label-expired';
        } elseif ($day_diff <= 10) {
            $label_class = 'label-warning';
        }
    }
?>
<td><b><span class="<?= $label_class ?>"><?= (isset($subscription_details->expire_date) && $subscription_details->expire_date!='1970-01-01') ? show_date($subscription_details->expire_date) : '' ?></span></b></td>
                                      </tr>
                                      <tr>
                                   ...
                                   <table class="table table-striped table-bordered">
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td><b><?=$user_details->first_name;?> <?=$user_details->last_name;?></b></td>
                                      </tr>
                                      <tr>
...
<script src="<?php echo $theme_link; ?>js/subscription.js?v=<?= time() ?>"></script>
