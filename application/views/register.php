...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <?php
      if($this->session->flashdata('success')!=''):
        ...
        <div class="alert alert-success alert-dismissable text-left">
          ...
          <strong><?= htmlspecialchars($this->session->flashdata('success'), ENT_QUOTES, 'UTF-8') ?></strong>
        </div>
      </div> 
         <?php 
      endif;
      if($this->session->flashdata('error')!=''):
        ...
        <div class="alert alert-danger alert-dismissable text-left">
           <a href="javascript:void()" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          <strong><?= htmlspecialchars($this->session->flashdata('error'), ENT_QUOTES, 'UTF-8') ?></strong>
        </div>
         <?php
      endif;
      ?>
    ...
    <?= form_open(base_url('register/register_store'), array('method'=>'POST', 'id'=>'registration_form'));?>
      <div class="div1">
      ...
      <div class="div2 hide">
        ...
        <div class="form-group has-feedback">
          <input type="text" class="form-control" name="city" class="input-text" placeholder=" *">
      ...
      <div class="div3 hide">
        ...
        <div class="form-group">
            <select class="form-control select2" id="currency_placement" name="currency_placement"  style="width: 100%;">
              <option value="">ตำแหน่งสกุลเงิน*</option>
     ...
     <div class="col-md-12">
       <table class="table table-bordered table-condensed text-center">         
            <tr>
              <td></td>
              <td> </td>
              <td><button type="button" class="btn btn-info btn-block btn-flat admin">ใช้งาน</button></td>
            </tr>
            </tbody>
          </table>
     </div>
