...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?= $this->lang->line('country_list'); ?>
        <small>View/Search </small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><?= $this->lang->line('country_list'); ?></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><?= $this->lang->line('country_list'); ?></h3>
              <?php if(special_access()) { ?>
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>country/add">
                <i class="fa fa-plus"></i> <?= $this->lang->line('new_country_sub'); ?></a>
              </div>
            <?php } ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered custom_hover" width="100%">
                <thead class="bg-gray ">
                <tr>
                  <th><?= $this->lang->line('country_sub'); ?></th>
