...
class Reports extends MY_Controller {
	...
	//Sales Debit Report 
	public function sales_debit(){
		if(!$this->permissions('sales_debit_report') && !$this->permissions('sales_return_report')){
			$this->show_access_denied_page();
		}
		$data=$this->data;
		$data['page_title']=$this->lang->line('sales_debit_report');
		$this->load->view('report-sales-debit', $data);
	}
	public function show_sales_debit_report(){
		...
		echo $this->reports->show_sales_debit_report();
	}
