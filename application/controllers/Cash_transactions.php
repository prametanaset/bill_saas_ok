	...
	public function ajax_list() {
		...
		foreach ($list as $cash) {
            ...
            if($cash->SALES_PAYMENT == "SALES_PAYMENT"){
                $account_of = 1;
            } else if($cash->SALES_PAYMENT == "PURCHASE_PAYMENT"){
                $account_of = 2;
            } else if($cash->SALES_PAYMENT == "SALES_RETURN_PAYMENT"){
                $account_of = 3;
            } else if($cash->SALES_PAYMENT == "PURCHASE_RETURN_PAYMENT"){
                $account_of = 4;
            } else if($cash->SALES_PAYMENT == "EXPENSE"){
                $account_of = 5;
            } else if($cash->SALES_PAYMENT == "SALES_DEBIT_PAYMENT"){
                $account_of = 6;
            }
