...
class Items extends MY_Controller {
	...
	public function add()
	{
		...
		$data['item_group_type']=$this->input->get('type');
	...
	public function newitems(){
		...
		if($this->input->post('item_group')=='Single' || $this->input->post('item_group')=='Combo'){
	...
	public function ajax_list()
	{
		...
		foreach ($list as $items) {
			...
			$row[] = $items->category_name."<br>[<label class='text-green'>".$service_or_item_name."</label>]";
	...
	public function return_combo_data_in_row($rowcount,$item_id){
		...
		$info['total_cost'] = $q1->row()->purchase_price;

		echo $this->items->return_combo_data_in_html_row($rowcount,$info);
	}
