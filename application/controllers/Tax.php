...
class Tax extends MY_Controller {
			...
			$row[] = $str;			
			         $str2 = '<div class="btn-group" title="View Account">
										...
										<ul role="menu" class="dropdown-menu dropdown-light pull-right">';
											...
											if($this->permissions('tax_edit') || is_admin())
											$str2.='<li>
											...
											if($this->permissions('tax_delete') || is_admin())
											$str2.='<li>
	...
	public function delete_tax(){
		...
		$result = $this->tax->delete_tax_from_table($id);
		echo $result;
	}
	public function multi_delete(){
		...
		$result = $this->tax->delete_tax_from_table($ids);
		echo $result;
	}
