...
class Items_model extends MY_Model {
	...
	public function preview_labels(){
		...
		<div style=" height:5in !important;  width:8.5in !important; line-height: 16px !important; ">
			<div class="inner-div-2" style=" height:1.2in !important;  width:1.6in !important; line-height: 16px !important;">
				<div style="">
					...
					for($i=1;$i<=$rowcount;$i++){
						...
						if(isset($_POST['tr_item_id_'.$i]) && !empty($_POST['tr_item_id_'.$i])){
							...
							?>
							<div style="height:1.2in !important; line-height: 1.2in; width:1.6in !important; display: inline-block; <?=$page_break;?>  " class="label_border text-center">
