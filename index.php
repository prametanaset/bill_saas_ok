<?php
file_put_contents(__DIR__ . '/tmp/request_log.txt', date('[Y-m-d H:i:s] ') . "FILE: " . __FILE__ . " | HOST: " . ($_SERVER['HTTP_HOST'] ?? 'N/A') . " | URI: " . ($_SERVER['REQUEST_URI'] ?? 'CLI') . " | POST: " . implode(',', array_keys($_POST)) . "\n", FILE_APPEND);
